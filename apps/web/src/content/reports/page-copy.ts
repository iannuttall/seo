...
export const reportPageCopy: Record<string, ReportPageCopy> = {
  ...
  'ai-referrals': {
    ...
    lead:
      'See which known AI assistants sent visits recorded by GA4 and where those visitors landed. It measures observed referrals, not general visibility inside an assistant.',
  },
  'ai-search-scorecard': {
  ...
  'crawl-diff': {
    ...
    lead:
      'Run the same bounded crawl again and see which technical findings changed. This is the quick release check when you need fresh evidence rather than a comparison of two existing snapshots.',
  },
  'site-crawl': {
    ...
    lead:
      'Crawl your site to find technical SEO problems and the pages affected by each one. Save the result as a baseline so you can investigate a finding or check a fix without starting from scratch.',
  },
  'ctr-underperformers': {
  ...
  'okf-build': {
    ...
    lead:
      'Turn a saved crawl into a portable OKF knowledge pack for an agent or another tool. The export keeps its manifest, source files and size limits explicit.',
  },
  'okf-validate': {
    title: 'OKF validator',
    description:
    ...
    lead:
      'Check an OKF knowledge pack before handing it to an agent. Broken paths and missing references are much cheaper to fix before they become confident answers.',
  },
  'page-opportunities': {
