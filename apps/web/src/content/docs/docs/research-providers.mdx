...
description: Connect optional research providers locally, control paid requests and combine keyword, domain, competitor, link and AI answer evidence with first-party data.
---
...
Domain Rating and bounded backlink evidence. The report contracts are provider
neutral, so the adapters return the same evidence shape where their
...
- `competitive-opportunities` turns a topic into a bounded keyword and
