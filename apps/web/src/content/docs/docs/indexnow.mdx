...
description: Generate a local IndexNow key, verify its public key file and submit a limited list of changed URLs without claiming they were indexed.
---
...
limited JSON request to the fixed IndexNow endpoint.
