...
2. Call `seo_describe_report` with `{"id":"cannibalisation"}`.
3. Call `seo_run_report` with `{"id":"cannibalisation","params":{"site":"sc-domain:example.com","days":90,"limit":20,"minImpressions":100,"includeBrand":false}}`.
