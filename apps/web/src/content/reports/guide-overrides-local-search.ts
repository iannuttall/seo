  ...
  'local-search-demand': {
    inputs: [
      ...
      },
      {
        ...
        role: 'Adds limited country, region, city, and session context only for exact returned local landing-page paths.',
      },
    ],
    checks: [
      ...
      'Combines returned queries and pages consistently, then finds repeated URL patterns for programmatic template review.',
      'Keeps exact local snapshots optional and limited, with their market, timestamp, features, cache, coverage, task state, and cost attached.',
      'Retains limited local-pack listings and aggregates recurring organic domains without guessing their business type.',
    ...
    returns: [
      ...
      'When requested, up to three complete or partial live result snapshots plus limited competitor and listing summaries, without blending exact rank into Search Console averages.',
    ...
    alternatives: [
      {
        when: 'You need all Search Console opportunities, including searches without explicit local wording.',
