...
Use the disconnect command to remove saved credentials, then
`seo reset --yes` to remove local configuration, caches, histories, spend
records, logs and saved reports. Environment credentials remain under the
control of your shell or runtime.
