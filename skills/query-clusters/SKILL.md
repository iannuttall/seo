...
2. Call `seo_describe_report` with `{"id":"query-clusters"}`.
3. Call `seo_run_report` with `{"id":"query-clusters","params":{"site":"sc-domain:example.com","scope":"/guides/","minImpressions":50,"limit":20,"includeBrand":false}}`.
