...
description: Give an AI agent structured SEO reports, focused follow-ups, local MCP tools, and one skill without filling its context with raw crawl or provider data.
---
...
[skill guide](/docs/skills) explains global and project installation. For the
